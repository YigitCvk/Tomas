      ...
      <div style={{ backgroundColor: "#F9FAFB", borderBottom: "1px solid #E4E7EF", padding: "56px 0 48px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 20 }}>
            ...
            <Link href="/hizmetler" style={{ fontSize: 13, color: "#6B7280", textDecoration: "none" }}>Hizmetler</Link>
            <span style={{ color: "#D1D5DB", fontSize: 13 }}>/</span>
            <span style={{ fontSize: 13, color: "#1A1F36", fontWeight: 500 }}>{service.title}</span>
          </div>
          <div style={{ display: "flex", alignItems: "flex-start", gap: 20 }}>
            <div style={{ width: 56, height: 56, backgroundColor: "#EBF1FF", borderRadius: 14, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              <Icon size={24} color="#0B5CFF" />
            </div>
            <div>
              <h1 style={{ fontWeight: 800, color: "#1A1F36", fontSize: "clamp(1.8rem,4vw,3rem)", lineHeight: 1.1, letterSpacing: "-0.02em", marginBottom: 12 }}>
                {service.title}
              </h1>
              {service.shortDescription && (
                <p style={{ fontSize: 16, color: "#6B7280", maxWidth: 600, lineHeight: 1.65 }}>
                  {service.shortDescription}
                </p>
              )}
            </div>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
          <div className="grid grid-cols-1 lg:grid-cols-3" style={{ gap: 24, alignItems: "start" }}>
            ...
            <main style={{ gridColumn: "span 2" }}>
              ...
              {/* CTA card */}
              <div style={{ marginTop: 20, background: "linear-gradient(135deg, #0B5CFF 0%, #003F9E 100%)", borderRadius: 16, padding: "40px" }}>
                <h3 style={{ fontWeight: 700, color: "#fff", fontSize: 20, marginBottom: 12 }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
                  <Link
                    href="/iletisim"
                    style={{ display: "inline-flex", alignItems: "center", gap: 8, backgroundColor: "#fff", color: "#0B5CFF", fontWeight: 700, fontSize: 14, padding: "11px 24px", borderRadius: 9999, textDecoration: "none" }}
                  >
                    Teklif Al <ArrowRight size={15} />
                  </Link>
                  <a
                    href="mailto:info@tomas.com.tr"
                    style={{ display: "inline-flex", alignItems: "center", gap: 8, backgroundColor: "rgba(255,255,255,0.15)", color: "#fff", fontWeight: 600, fontSize: 14, padding: "11px 24px", borderRadius: 9999, textDecoration: "none", border: "1px solid rgba(255,255,255,0.3)" }}
                  >
                    <Mail size={15} /> E-posta
                  </a>
                </div>
                <div style={{ marginTop: 24, paddingTop: 24, borderTop: "1px solid rgba(255,255,255,0.15)", display: "flex", flexWrap: "wrap", gap: 20 }}>
                  <a href="tel:+902123025935" style={{ display: "flex", alignItems: "center", gap: 8, color: "rgba(255,255,255,0.6)", fontSize: 13, textDecoration: "none" }}>
                    <Phone size={13} /> 0 (212) 302 59 35
                  </a>
                  <a href="mailto:info@tomas.com.tr" style={{ display: "flex", alignItems: "center", gap: 8, color: "rgba(255,255,255,0.6)", fontSize: 13, textDecoration: "none" }}>
              ...
              <aside>
                <div style={{ backgroundColor: "#fff", borderRadius: 16, padding: "24px", border: "1px solid #E4E7EF", position: "sticky", top: 80 }}>
                    ...
                    {related.map((s) => {
                      ...
                      return (
                        <Link
                          ...
                          style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 10, textDecoration: "none", color: "#1A1F36" }}
                        >
                          <SIcon size={14} color="#0B5CFF" />
                          <span style={{ fontSize: 13, fontWeight: 500, flex: 1 }}>{s.title}</span>
                          <ArrowRight size={11} color="#6B7280" />
                        </Link>
                      );
                    })}
                  </div>
                  <div style={{ marginTop: 16, paddingTop: 16, borderTop: "1px solid #E4E7EF" }}>
                    <Link
                      href="/iletisim"
                      style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, width: "100%", padding: "12px", backgroundColor: "#0B5CFF", color: "#fff", fontWeight: 600, fontSize: 13, borderRadius: 9999, textDecoration: "none" }}
                    >
